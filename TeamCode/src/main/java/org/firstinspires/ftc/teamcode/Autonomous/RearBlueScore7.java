...
public class RearBlueScore7 extends OpMode {
    ...
    private final Pose shootLong = new Pose(62.5, 15, Math.toRadians(113));
...
//                break;
    ...
    public void buildPaths() {
        ...
        moveOutOfScore.setLinearHeadingInterpolation(shootLong.getHeading(), Math.toRadians(180));
        ...
        line2Intake.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
