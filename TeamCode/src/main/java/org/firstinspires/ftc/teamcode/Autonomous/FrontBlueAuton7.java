...
@Autonomous(name = "FrontBlueAuton7")
public class FrontBlueAuton7 extends OpMode {
    Intake intake;
    ...
    public void autonomousPathUpdate() {
        switch(pathState) {
            ...
            case 12:
                if (pathTimer.getElapsedTimeSeconds()>0.78) {
                    outtake.closeBoot();
                    setPathState(13);
                }
                break;
    ...
    public void buildPaths() {
        ...
        line2moveToIntake = new Path(new BezierLine(new Pose(readyToIntakeLine2.getX(), readyToIntakeLine2.getY()), new Pose(21, readyToIntakeLine2.getY())));
        ...
        moveToScore3 = new Path(new BezierCurve(new Pose(21, readyToIntakeLine2.getY()), new Pose(42.3, 63.3), scoreShort));
        moveToScore3.setLinearHeadingInterpolation(readyToIntakeLine2.getHeading(), scoreShort.getHeading());

        park = new Path(new BezierLine(scoreShort, new Pose(scoreShort.getX()-28, scoreShort.getY()-5)));
