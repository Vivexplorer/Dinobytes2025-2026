...
@Autonomous(name = "FrontRedAuton6")
public class FrontRedAuton6 extends OpMode {
    Intake intake;
    ...
    public void buildPaths() {
        ...
        moveToScore3 = new Path(new BezierCurve(new Pose(124, readyToIntakeLine2.getY()), new Pose(101.7, 63.3), new Pose(startPose.getX()+5, startPose.getY()+20)));
        moveToScore3.setLinearHeadingInterpolation(readyToIntakeLine2.getHeading(), Math.toRadians(90));

        park = new Path(new BezierLine(scoreShort, new Pose(scoreShort.getX()+29, scoreShort.getY()+10)));
